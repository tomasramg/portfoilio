...
export const headData = {
  ...
  description: 'Bienvenido al portfolio del desarrollador web jr. Tomás Ramírez González, donde podrás encontrar soluciones a tus proyectos Full Stack (JavaScript, PHP).', // e.g: Welcome to my website
};
...
export const aboutData = {
  img: 'tomas.jpg',
  paragraphOne: 'Soy un programador que ha desarrollado habilidades en HTML5, CSS, JavaScript y PHP en el bootcamp de Upgrade Hub, durante la cuarentena causada por el COVID-19.',
...
export const projectsData = [
  ...
  },
  {
    ...
    info2: '',
    url: 'https://gitlab.com/tomasramg/Lucky',
    repo: 'https://gitlab.com/tomasramg/Lucky', // if no repo, the button will not show up
  },
  {
    id: nanoid(),
    img: 'Maleteo.jpg',
    ...
    info2: '',
    url: 'https://gitlab.com/tomasramg/maleteo-landing',
